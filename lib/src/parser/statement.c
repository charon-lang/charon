...
static void parse_return(parser_t *parser) {
    parser_open_element(parser);
...
static void parse_if(parser_t *parser) {
    parser_open_element(parser);
...
static void parse_while(parser_t *parser) {
    parser_open_element(parser);
...
static void parse_for(parser_t *parser) {
    parser_open_element(parser);
...
static void parse_switch(parser_t *parser) {
    parser_open_element(parser);
...
static void parse_continue(parser_t *parser) {
    parser_open_element(parser);
...
static void parse_break(parser_t *parser) {
    parser_open_element(parser);
