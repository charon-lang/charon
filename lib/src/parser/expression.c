...
static void helper_binary_operation(parser_t *parser, void (*func)(parser_t *), size_t count, ...) {
...
static void parse_numeric_literal(parser_t *parser) {
...
static void parse_string_literal(parser_t *parser) {
    parser_open_element(parser);
...
static void parse_char_literal(parser_t *parser) {
    parser_open_element(parser);
...
static void parse_bool_literal(parser_t *parser) {
    parser_open_element(parser);
...
static void parse_identifier(parser_t *parser) {
    parser_open_element(parser);
...
static void parse_primary(parser_t *parser) {
    ...
    switch(parser_peek(parser)) {
        ...
        default:                                   {
            ...
            diag_data_t *diag_data = malloc(sizeof(diag_data_t) + sizeof(kinds));
...
static void parse_unary_post(parser_t *parser) {
    parser_event_t *checkpoint = parser_checkpoint(parser);
...
static void parse_unary_pre(parser_t *parser) {
    parser_event_t *checkpoint = parser_checkpoint(parser);
...
static void parse_factor(parser_t *parser) {
...
static void parse_equality(parser_t *parser) {
    helper_binary_operation(parser, parse_comparison, 2, CHARON_TOKEN_KIND_PNCT_DOUBLE_EQUAL, CHARON_TOKEN_KIND_PNCT_NOT_EQUAL);
}

static void parse_bitwise_and(parser_t *parser) {
    helper_binary_operation(parser, parse_equality, 1, CHARON_TOKEN_KIND_PNCT_AMPERSAND);
}

static void parse_bitwise_xor(parser_t *parser) {
    helper_binary_operation(parser, parse_bitwise_and, 1, CHARON_TOKEN_KIND_PNCT_CARET);
}

static void parse_bitwise_or(parser_t *parser) {
    helper_binary_operation(parser, parse_bitwise_xor, 1, CHARON_TOKEN_KIND_PNCT_PIPE);
}

static void parse_logical_and(parser_t *parser) {
    helper_binary_operation(parser, parse_bitwise_or, 1, CHARON_TOKEN_KIND_PNCT_LOGICAL_AND);
}

static void parse_logical_or(parser_t *parser) {
    helper_binary_operation(parser, parse_logical_and, 1, CHARON_TOKEN_KIND_PNCT_LOGICAL_OR);
}

static void parse_assignment(parser_t *parser) {
    parser_event_t *checkpoint = parser_checkpoint(parser);
