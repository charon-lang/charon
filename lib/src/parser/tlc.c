...
static void parse_import(parser_t *parser) {
...
static void parse_attribute(parser_t *parser) {
    parser_open_element(parser);
...
static void parse_type_definition(parser_t *parser) {
    parser_open_element(parser);
...
static void parse_module(parser_t *parser) {
    parser_open_element(parser);
...
static void parse_function(parser_t *parser) {
    parser_open_element(parser);
...
static void parse_extern(parser_t *parser) {
    parser_open_element(parser);
...
static void parse_declaration(parser_t *parser) {
    parser_open_element(parser);
...
static void parse_enum(parser_t *parser) {
    parser_open_element(parser);
